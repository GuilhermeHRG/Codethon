...
const noticias = [
  ...
  },
  {
    ...
    foto: "https://img.freepik.com/fotos-gratis/espaco-astronauta-na-orbita-da-terra_23-2149008475.jpg?t=st=1719661535~exp=1719665135~hmac=3d239542d37c6909fa6d44ec9e5d51080fa4c70288579c0d9e5e6df340717914&w=900",
  },
  {
    id: 14,
    ...
    foto: "https://img.freepik.com/fotos-gratis/ciberseguranca_1138-1367.jpg?t=st=1719661627~exp=1719665227~hmac=fbdc7b18e2c40f446519563a037e15ab5da6e43972e5688c43802e1d751fe53e&w=900",
  },
  {
    id: 15,
    ...
    foto: "https://img.freepik.com/fotos-gratis/diagnostico-medico_1150-34054.jpg?t=st=1719661711~exp=1719665311~hmac=8b7738e5f029d07272c787b6df2c863ac65d26b6231a5e2e582dfc8f47c86816&w=900",
  },
];
...
export default function NoticiasLocais() {
  ...
  const [visibleNoticas, setVisibleNoticas] = useState(noticias.slice(0, 12));
  const [currentIndex, setCurrentIndex] = useState(12);

  const carregarMaisNoticias = () => {
    const nextIndex = currentIndex + 12;
    const maisNoticias = noticias.slice(currentIndex, nextIndex);
    setVisibleNoticas((prevNoticas) => [...prevNoticas, ...maisNoticias]);
  ...
  return (
    <section className="flex flex-col justify-center items-center bg-white mx-8 md:mx-16 my-16">
      <header className="flex flex-col gap-2 text-center mb-8">
        <h2 className="text-2xl md:text-5xl font-bold">NOTÍCIAS LOCAIS</h2>
      ...
      <button
        onClick={() => navigate('/todas-as-noticias')}
        className="bg-blue-600 text-white text-xl p-4 font-medium rounded-xl hover:bg-blue-700"
      >
        Ver mais Notícias
      </button>
    </section>
